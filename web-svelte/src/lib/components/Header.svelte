...
<header class="flex flex-wrap items-center py-4 mb-4 bg-white border-b border-gray-200 dark:bg-(--color-header-dark) dark:border-(--color-header-dark)">
	<a href="/" class="flex items-center gap-2 ml-6 mr-auto no-underline">
		...
		<span class="text-2xl font-bold text-[#111] dark:text-[#f0f6fc]">Dockge</span>
	</a>
	...
	<div class="mr-6 shrink-0 xl:order-1">
		<button class="flex items-center gap-[6px] bg-[rgba(200,200,200,0.2)] border-none py-2 px-[0.8rem] rounded-full cursor-pointer text-inherit hover:bg-white/20" aria-label="User menu">
